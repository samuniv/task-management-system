...
window.serviceWorkerManager = {
    ...
    showUpdateNotification() {
        if (window.blazorCulture && window.blazorCulture.dotNetHelper) {
            ...
            window.blazorCulture.dotNetHelper.invokeMethodAsync('OnServiceWorkerUpdate');
        } else {
    ...
    notifyConnectivityChange(isOnline) {
        if (window.blazorCulture && window.blazorCulture.dotNetHelper) {
            window.blazorCulture.dotNetHelper.invokeMethodAsync('OnConnectivityChanged', isOnline);
        }
